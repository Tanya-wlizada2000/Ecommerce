...
export const database = [
  {
    id: 1,
    heading:
      "China Custom DOY PACK Zipper Bag for Candy Sweet Chocolate Food Packaging",
    pragh:
  ...
  },
  {
    ...
    pragh:
      "The heat seal bag has strong sealing, which is convenient for storing goods and no leaking.<br/><br/>Stand up heat seal bags can stand upright on a shelf to enhance aesthetics. Stand up heat seal pouch offer market-friendly features to consumers. For example, you can choose whether to add zippers, tear notch, hanging holes, etc., a strong shelf presence, and attractive billboards for labels and graphics.<br/><br/>Stand up pouches are sold to a variety of markets, including juice, coffee, tea, natural products, and specialty foods.",
    image: "/Group4.png",
    img1: "/Group4.png",
    img2: "/Frame 62.png",
    img3: "/Frame 63.png",
  ...
  },
  {
    ...
    pragh:
      "This dog food bag adpots three-layer material structure, which can reduce the probability of bag breakage. Colorful and lovely design is more attractive to customers. we can print up to 13 colors ,using gravure printing, the actual product is closer to the design.<br/><br/>This dog food bag adds a visual window through which consumers can see the contents of the bag clearly, and also adds an aircraft hole, making this bag suitable for display in supermarkets. Accept custom size and printing.",
    image: "/Group8.png",
    img1: "/Group8.png",
    img2: "/Frame 24.png",
    img3: "/Frame 25.png",
  ...
  },
  {
    ...
    pragh: "Stand up zipper pouch can be opened and closed repeatedly,with strong sealing, convenient to save goods and prevent moisture. <br/><br/>Stand up zipper pouch can be placed standing up on the shelf to enhanced the aesrhetics.The stand-up zipper pouch provides consumers with market-friendly features. For example, you can choose whether to add a zipper, whether to add a tear, whether to add a hanging hole, etc., strong shelf presence and an attractive billboard for label and graphics.<br/><br/>Stand-up pouches are sold into a wide variety of markets including pet food, coffee, tea, natural products and specialty foods.",
    image: "/Group19.png",
    img1: "/Group19.png",
    img2: "/Frame 7.png",
    img3: "/Frame 6.png",
  ...
  },
  {
    ...
    pragh: "Quad Seal Pouch is similar in format to the side gusset bag, Quad Seal Bags create a distinctive difference in shelf appearance. Sealed on the four corners of the bag, rather than the back, the quad seal bag offers four crisp, clean panels for labels and graphic placement and an overall strong shelf presence",
    image: "/Group23.png",
    img1: "/Group23.png",
    img2: "/Frame 36.png",
    img3: "/Frame 32.png",
  ...
  },
  {
    ...
    pragh: "With the improvement of people’s living standards, the requirements for fruit packaging and preservation are getting higher and higher, which urges fruit manufacturers to improve and perfect the inner packaging of fruit, so as to improve the freshness of fruit.",
    image: "/Group32.png",
    img1: "/Group32.png",
    img2: "/Frame 45.png",
    img3: "/Frame 29.png",
